      ...
      bottomNavigationBar: Container(
        ...
        decoration: const BoxDecoration(
            borderRadius: BorderRadius.only(
                ...
                boxShadow: [BoxShadow(blurRadius: 4, color: Colors.black26, offset: Offset(0, 0))]),
        child: ClipRRect(
          ...
          child: BottomNavigationBar(
            ...
            BottomNavigationBarItem(
              activeIcon: Image.asset("assets/icons/home_selected.png"),
                label: "", icon: Image.asset("assets/icons/home.png")),
            BottomNavigationBarItem(
              activeIcon: Image.asset("assets/icons/heart_selected.png"),
                label: "", icon: Image.asset("assets/icons/heart_empty.png")),
            BottomNavigationBarItem(
              activeIcon: Image.asset("assets/icons/basket_selected.png"),
                label: "", icon: Image.asset("assets/icons/basket.png")),
            BottomNavigationBarItem(
              activeIcon: Image.asset("assets/icons/person_selected.png"),
                label: "", icon: Image.asset("assets/icons/person.png")),
          ]),
        ),
      ),
