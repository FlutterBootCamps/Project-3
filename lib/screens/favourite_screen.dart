    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text("Favorite", style: TextStyle(color: designColors[2], fontFamily: "Poppins", fontSize: 32, fontWeight: FontWeight.bold),),
            const SizedBox(height: 34.7,),
            SizedBox(
              height: 560,
              child: ListView(
              children: List.generate(GetIt.I.get<HomeData>().favoritePlants.length, (index) {
                Plant currentPlant = GetIt.I.get<HomeData>().favoritePlants[index];
                return FavoritePlantContainer(plant: currentPlant, notifyParent: refresh,);
              }),
                              ),
            )
          ],
