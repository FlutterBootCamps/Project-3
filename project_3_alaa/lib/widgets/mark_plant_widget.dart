...
class MarkPlant extends StatefulWidget {
  MarkPlant({super.key, required this.plant});
  late int count = 1;
  final Plants plant;

  @override
  State<MarkPlant> createState() => _MarkPlantState();
}

class _MarkPlantState extends State<MarkPlant> {
  @override
                ...
                InkWell(
                  onTap: () {
                    setState(() {
                      GetIt.I
                          .get<PlantDataLayer>()
                          .deleteMarkPlant(plant: widget.plant);
                    });
                  },
